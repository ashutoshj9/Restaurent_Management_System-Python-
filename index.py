...
def LoginForm():
    ...
    btn_login = Button(LoginFrame, text="Login", font=('arial bold', 18), width=35, command=Login, cursor="hand2")
    btn_login.grid(row=4, columnspan=2, pady=15)
    lbl_register = Button(LoginFrame, text="Register", font=('arial bold', 18), width=35, command=Register, cursor="hand2")
    lbl_register.grid(row=5, columnspan=2, pady=1)
...
def RegisterForm():
    ...
    btn_login = Button(RegisterFrame, text="Register", font=('arial bold', 18), width=35, command=Register, cursor="hand2")
    btn_login.grid(row=6, columnspan=2, pady=20)
    lbl_login = Label(RegisterFrame, text="Login", fg="Blue", font=('arial bold', 14), cursor="hand2")
